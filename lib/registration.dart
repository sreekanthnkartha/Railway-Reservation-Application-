...
class _RegPageState extends State<RegPage> {
  ...
  var locations = ['District','Alappuzha', 'Eranakulam', 'Idukki', 'Kannur', 'Kasargod', '	Kollam','	Kottayam','Kozhikode','Malappuram','Palakkad','Pathanamthitta','Thiruvananthapuram','Thrissur','Wayanad'];
  var first = 'District';
  //UI here
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.blueGrey,title: Text("Registration"),),
        body:
        Center(
          child: GestureDetector(
            ...
            child: SingleChildScrollView(child:Stack(
              children: <Widget>[
                ...
                CachedNetworkImage(
                  imageUrl: "https://www.wallpapertip.com/wmimgs/174-1749637_dubai-metro.jpg"
                ),
                Container(
                  ...
                  child: Padding(
                    ...
                    child: ListView(
                      shrinkWrap: true,//you must add this if you place listview inside scrollview
                      physics: NeverScrollableScrollPhysics(),//to prevent default scrolling of listview
                      children: <Widget>[
